...
object ImperativeAndLazyIO {
	 ...
	 * 
	 * Our first implementation is an imperative implementation, embedded into `IO`.
	 */
	 ...
	 * 
	 * <ul>
	 * <li>Check whether the number of _nonempty_ lines in the file exceeds 40,000</li>
	 * <li>Find a line index before 40,000 where the first letter of consecutive lines spells out `"abracadabra"`.</li>
	 * </ul>
	 * 
...
object GeneralizedStreamTransducers {
	 ...
	 * forceful termination, indicated by the special exception `Kill`,
	 * or some other error.
	 * 
